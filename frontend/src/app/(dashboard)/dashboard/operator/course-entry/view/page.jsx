...
import { 
  ...
  FaBuilding, FaBook, FaCalendarAlt, FaCheck, FaLock, FaExclamationTriangle, FaFilePdf, FaFileCsv, FaPrint,
...
export default function CourseEntryListPage() {
              ...
              <div className="flex flex-wrap gap-3 items-center">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-10">
                    <button
                      onClick={exportToPDF} disabled={exporting || filteredEntries.length === 0}
