...
export default function CourseListDetailPage() {
  const { user } = useAuth();
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="bg-white rounded-xl shadow-sm p-6 border border-gray-400">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-400 p-6 mb-4">
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            <div className="w-full lg:w-96 h-10 bg-gray-400 rounded-lg animate-pulse"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="bg-white rounded-xl shadow-sm border border-gray-400 overflow-hidden">
              ...
              <div className="p-5 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <div className="h-3 w-12 bg-gray-400 rounded animate-pulse"></div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <div className="h-3 w-10 bg-gray-400 rounded animate-pulse"></div>
                    <div className="h-6 w-16 bg-gray-400 rounded-full animate-pulse"></div>
                  </div>
                  <div className="space-y-2">
                    <div className="h-3 w-14 bg-gray-400 rounded animate-pulse"></div>
                ...
                <div className="flex gap-3 pt-4 border-t border-gray-200">
                  <div className="flex-1 h-9 bg-gray-400 rounded-lg animate-pulse"></div>
                  <div className="flex-1 h-9 bg-gray-400 rounded-lg animate-pulse"></div>
                  <div className="flex-1 h-9 bg-gray-400 rounded-lg animate-pulse"></div>
                </div>
              </div>
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-400 overflow-hidden">
          ...
          {[...Array(5)].map((_, i) => (
            <div key={i} className="border-b border-gray-400 p-4">
              <div className="grid grid-cols-7 gap-4">
                {[...Array(7)].map((_, j) => (
            ...
            <div className="w-full lg:w-96">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Search courses by name, category, centre..."
                  value={searchTerm}
        ...
        {viewMode === 'grid' ? (
              ...
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                  {currentItems.map((course) => (
                    <div
                      key={course.id}
                      className="bg-white rounded-xl shadow-md shadow-gray-600 border border-gray-700 hover:shadow-lg transition-all duration-200 overflow-hidden"
                    >
                      {/* Card Header */}
                      <div className="border-b border-gray-200 px-5 py-4 bg-gradient-to-r from-gray-50 to-white">
                        <div className="flex items-start justify-between gap-3">
                          <div className="flex items-center gap-3 flex-1 min-w-0">
                            ...
                            <Link    href={`/dashboard/operator/course/view/${course.id}`}
                             className="font-semibold text-gray-900 text-lg truncate hover:underline underline-offset-4" title={course.course_name}>
                      ...
                      <div className="p-5 space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-3 pt-4 border-t border-gray-200">
                          <button
                            ...
                            className="flex-1 flex items-center justify-center gap-2 bg-gray-50 hover:bg-gray-500 hover:text-white text-gray-700 px-4 py-2.5 rounded-lg text-sm font-medium transition-colors border border-gray-600"
                          >
                          ...
                          href={`/dashboard/operator/course/view/${course.id}`}
                            className="flex-1 flex items-center justify-center gap-2 bg-gray-50 hover:bg-blue-600 hover:text-white text-blue-700 px-4 py-2.5 rounded-lg text-sm font-medium transition-colors border  border-blue-500"
                          >
                          ...
                          <Link
                            ...
                            className="flex-1 flex items-center justify-center gap-2 bg-amber-50 hover:bg-amber-100 text-amber-700 px-4 py-2.5 rounded-lg text-sm font-medium transition-colors border border-amber-400"
                          >
                          ...
                          <button
                            ...
                            className="flex-1 flex items-center justify-center gap-2 bg-rose-50 hover:bg-red-500 text-rose-700 hover:text-white px-4 py-2.5 rounded-lg text-sm font-medium transition-colors border border-rose-200"
                          >
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-700 overflow-hidden">
            <table className="min-w-full divide-y divide-gray-200 overflow-x-auto">
              <thead className="bg-blue-800 text-white text-left text-xs md:text-sm font-medium uppercase tracking-wider">
                <tr>
                  <th className="px-3 py-2 ">
                    <button onClick={() => handleSort('course_name')} className="flex items-center gap-1 hover:text-blue-200">
                      Course Name {getSortIcon('course_name')}
                    </button>
                  </th>
                  <th className="px-3 py-2 ">
                    <button onClick={() => handleSort('category')} className="flex items-center gap-1 hover:text-blue-200">
                      Category {getSortIcon('category')}
                    </button>
                  </th>
                  <th className="px-3 py-2 ">
                    <button onClick={() => handleSort('centre')} className="flex items-center gap-1 hover:text-blue-200">
                      Centre {getSortIcon('centre')}
                    </button>
                  </th>
                  <th className="px-3 py-2 ">
                    <button onClick={() => handleSort('course_mode')} className="flex items-center gap-1 hover:text-blue-200">
                      Mode {getSortIcon('course_mode')}
                    </button>
                  </th>
                  <th className="px-3 py-2 ">
                    <button onClick={() => handleSort('course_duration')} className="flex items-center gap-1 hover:text-blue-200">
                      Duration {getSortIcon('course_duration')}
                    </button>
                  </th>
                  <th className="px-3 py-2 ">
                    <button onClick={() => handleSort('course_status')} className="flex items-center gap-1 hover:text-blue-200">
              ...
              <tbody className="divide-y divide-gray-200">
                {currentItems.length > 0 ? (
                  currentItems.map((course) => (
                    <tr key={course.id} className="hover:bg-gray-50 transition-colors border-b border-gray-600">
                      <td className="px-3 py-2">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm font-medium text-gray-900">
                            <Link    href={`/dashboard/operator/course/view/${course.id}`} className='hover:underline underline-offset-4 font-semibold'>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          >
                            <FaEye />
                               ...
                               <Link
                          href={`/dashboard/operator/course/view/${course.id}`}
                            className="flex-1 flex items-center justify-center gap-2 bg-gray-50 hover:bg-blue-600 hover:text-white text-blue-700 px-2 py-1.5 rounded-lg text-sm font-medium transition-colors border border-gray-200"
                          >
                            <TbListDetails className="text-sm" />
                            Detail
                          </Link>
                          <Link
                            href={`/dashboard/operator/course/edit-course/${course.id}`}
                          ...
                          <button
                            onClick={() => handleDelete(course.id, course.course_name)}
                            className="text-rose-600 hover:text-white p-2 rounded-lg hover:bg-red-500 transition-colors"
                            title="Delete"
                          >
                            <MdDelete />
                          </button>
